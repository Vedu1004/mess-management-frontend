...
<div className="container my-2 flex flex-wrap mt-2 max-w-[90%] rounded-2xl  mb-4 min-h-[10vh] bg-gradient-to-r from-[#FFDAB9] via-[#FFE5B4] to-[#FFEFD5] flex-col md:flex-row items-center">
        <Link
          to="/"
        ...
        >
          ...
          <span className="ml-3 text-xl text-black hover:no-underline no-underline">
            Mess Care
          </span>
        </Link>
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
          <Link
            to="/"
            className="mr-5 text-gray text-lg hover:text-gray-900 hover:no-underline"
          >
            Home
          </Link>
          <Link
          ...
          <Link
            to="/about"
            className="mr-5 hover:text-gray-900 text-gray text-lg hover:no-underline"
          >
            About us
          </Link>
        </nav>
